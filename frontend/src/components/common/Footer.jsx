                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-3">
                            ...
                            <div className='pt-3 pe-5 mb-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel, excepturi.</div>
                        </div>
                        ...
                        <div className="col-md-3">
                            ...
                            <ul>
                                <li><a href="">+880 1700 000 000</a></li>
                                <li><a href="">demo@email.com</a></li>
                            </ul>
                        </div>
                    </div>
